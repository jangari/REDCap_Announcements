...
<p>
    <ol>
        ...
        <li><strong>Important:</strong> Go into the newly created project's designer and update the query for the <code>[cat]</code> Dynamic SQL field to correctly pull from the Categories:<br/>
            <pre>SELECT record,value FROM [data-table] WHERE project_id = [project-id] AND field_name = 'category'</pre><br/>
            This must be done since SQL queries may not be imported by XML.</li>
